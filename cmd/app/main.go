...
func main() {
    ...
    // Ejemplo de inicialización temporal (deja nil para que el compañero lo complete)
    // productoRepo = NewProductoRepo() // <-- Implementar
    // productorRepo = NewProductorRepo() // <-- Implementar
